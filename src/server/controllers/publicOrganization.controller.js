...
exports.list = (req, res, next) => {
    ...
    paginationOptions.select = 'name shortName color theme cover title description contactEmail address schedule additionalInformation welcomeTitle';
...
exports.loadOrganizationSettings = (req, res, next) => {
    ...
    Organization.findOne({_id: currentOrganizationId})
        .select('title description contactLocation contactEmail address schedule additionalInformation welcomeTitle updatedAt')
        .lean()
