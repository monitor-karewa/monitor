...
module.exports = {
    ...
    'Login success': function (browser) {
        ...
        browser
            ...
            .assert.containsText(utils.xpath.body(), "Bienvenido Administrador")
            ...
            .assert.visible(utils.xpath.elementWithText("a", "INICIAR SESIÓN"))
            ...
            .setValue(utils.xpath.elementWithId("input", "username"), "admin123")
            .setValue(utils.xpath.elementWithId("input", "password"), "123")
            .click('//a[contains(text(), "INICIAR SESIÓN")]')
            .useXpath()
            .click("#password")
            .click(utils.xpath.elementWithText("a", "INICIAR SESIÓN"))

            //should login correctly
            .pause(500)
            .assert.containsText('/html[1]/body[1]', 'Vistas del monitor')
