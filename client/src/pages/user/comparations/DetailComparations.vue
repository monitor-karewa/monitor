                            ...
                            <div class="col-4 p-30">
                                <div class="tacometro-container">
                                    ...
                                    <div class="gauge-container">
                                        ...
                                        <div class="text">
                                            <div id="gauge-text-test2">25</div>
                                            %
                                        </div>
                                        <div class="prob">text</div>
                                    </div>
                     ...
                     <template id="help-tooltip-contratos">
                      <div class="help-tooltip-div">
                        ...
                        <p>TEXTO FALTANTE</p>
                            ...
                            <div class="col-4 p-l-20 p-r-20 p-t-20 p-b-20">
                                <p class="f-16 c-accent principal-font-bold text-upper text-align-c d-block m-b-0"> 681
                                    contratos </p>
                            </div>
    ...
    export default {
        ...
        mounted() {
            if (document.getElementsByClassName("gauge").length) {
                (function () {
                    var t, i, e, s, n, o, a, h, r, l, p, c, u, d = [].slice, g = {}.hasOwnProperty,
                        m = function (t, i) {
                            function e() {
                                this.constructor = t
                            }
                    ...
                    !function () {
                        ...
                        return m(i, t), i.prototype.elem = null, i.prototype.value = [20], i.prototype.maxValue = 80, i.prototype.minValue = 0, i.prototype.displayedAngle = 0, i.prototype.displayedValue = 0, i.prototype.lineWidth = 40, i.prototype.paddingTop = .1, i.prototype.paddingBottom = .1, i.prototype.percentColors = null, i.prototype.options = {
                            ...
                            if (t.length > this.gp.length) for (e = n = 0, l = t.length - this.gp.length; 0 <= l ? n < l : n > l; e = 0 <= l ? ++n : --n) i = new o(this), i.setOptions(this.options.pointer), this.gp.push(i); else t.length < this.gp.length && (this.gp = this.gp.slice(this.gp.length - t.length));
                            ...
                            var e, s, n, o, a, h, r;
                            if (0 === t) e = this.percentColors[0].color; else for (e = this.percentColors[this.percentColors.length - 1].color, n = o = 0, h = this.percentColors.length - 1; 0 <= h ? o <= h : o >= h; n = 0 <= h ? ++o : --o) if (t <= this.percentColors[n].pct) {
