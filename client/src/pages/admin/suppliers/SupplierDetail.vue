            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-centered">Estás a punto de descargar los datos aplicando los filtros seleccionados.
                            <br>
                            <strong>¿Estás seguro de continuar con esta acción?</strong>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn-stroke button-accent" data-dismiss="modal">Descargar lista completa</button>
                        <button type="button" class="btn-stroke button-accent" data-dismiss="modal">Descargar datos filtrados</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="client-content">
            <div class="neutral-width">
                ...
                <div class="col-12 p-0 m-t-20 m-b-20 d-flex">
                    <a href="" class="btn-outline text-unset"><i class="zmdi zmdi-long-arrow-left"></i> Regreso a Proveedores </a>
                </div>
                    ...
                    <div class="card o-visible">
                        <div class="floating-title-panel">
                            ...
                            <div class="side-right">
                                ...
                                <button  class="btn-raised button-accent text-capi m-l-10" data-toggle="modal" data-target="#modalAlertSuccess" tabindex=""><i class="zmdi zmdi-download"></i> DESCARGAR DATOS DEL PROVEEDOR</button>
                            </div>
                        </div>

                        <p class="f-14 c-plain_text principal-font-regular">Aquí podrás encontrar la lista de todos los contratos del proveedor
                ...
                <div class="card">
                    <div class="floating-title-panel small">
                        <h1>Contratos</h1>
                        <p class="d-block f-14 c-plain_text principal-font-regular m-b-40">Se registró un total de 28 contratos en el Periodo Administrativo 2016 - 2018. <br/> Para ver
...
<script>
    ...
    export default {
        data() {
            return {
                contratos: [
                    {titulo:"OBRA CIVIL PARA LA IMPLEMENTACIÓN DE LA PLATAFORMA ESCUDO CHIHUAHUA EN LA CIUDAD DE…", cantidad:"$26,327,329.17", fecha:"20 de octubre de 2017"},
                    {titulo:"RECONSTRUCCIÓN DE COLECTOR DE AGUAS RESIDUALES, UBICADO EN LA COLONIA CDP", cantidad:"$1,799,989.08", fecha:"23 de abril de 2018"},
                    {titulo:"CANALIZACIÓN DE ARROYO MAGALLANES,  DE C. CARMEN SERDAN A C. CAMILO TORRES DE LA COL…", cantidad:"$1,180,547.00", fecha:"20 de marzo de 2017"},
                    {titulo:"CONSTRUCCIÓN DE TECHUMBRE METÁLICA TIPO DOMO 17.50 X 22.25 M.  EN ESCUELA PRIMARIA FEDERAL…", cantidad:"$787,340.64", fecha:"14 de septiembre de 2017"},
                    {titulo:"TRABAJOS EN COMANDANCIA NORTE  DE LA DIRECCIÓN DE SEGURIDAD PUBLICA MUNICIPAL.", cantidad:"$746,191.48", fecha:"8 de agosto de 2018"},
                    {titulo:"CANALIZACIÓN DE ARROYO MAGALLANES,  DE C. CARMEN SERDAN A C. CAMILO TORRES DE LA COL…", cantidad:"$415,054.032", fecha:"31 de julio de 2018"},
                    {titulo:"OBRA CIVIL PARA LA IMPLEMENTACIÓN DE LA PLATAFORMA ESCUDO CHIHUAHUA EN LA CIUDAD DE…", cantidad:"$202,222.64", fecha:"25 de junio de 2017"}
                ]
            }
        },
        components: {
