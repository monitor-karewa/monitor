...
<div>
            ...
            <div class="links">
                ...
                <div class="topMenuDropdown dropdown">
                    <button class="dropdown-toggle" type="button" id="dropdownUserMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img class="img-fluid" src="./../../public/images/Demo/user-test.jpg" alt="User" />
                    </button>
    ...
    <aside id="sidebar" class="sidebar">
        <div id="" class="">
            <div class="top-logo">
                <div class="logo-full">
                    <img class="img-fluid" src="./../../public/images/Logos/logo-karewa-xs.png" alt="Logo" />
                    <div>
                        <small>Monitor</small>
                        <label>Karewa</label>
                    </div>
            ...
            <ul class="main-menu">
                <!--Iterar grupos de enlaces-->
                <template v-for="(linkArray, linkArrayIndex) in links">
...
@import './../../public/stylesheets/dist/vendors.min.css';
</style>
